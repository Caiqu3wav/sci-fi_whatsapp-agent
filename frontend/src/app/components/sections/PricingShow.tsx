...
export default function PricingShow() {
  return (
    <section id="pricing" className="py-20 bg-primary-50 w-full">
        <div className="container   text-white mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-purple py-1 px-4 rounded-full text-sm font-medium">
                    Mais popular
                  </div>
                )}
                ...
                <button 
                  className={`w-full cursor-pointer ${plan.popular ? 'bg-primary-100 hover:bg-primary-200' : 'bg-primary-100 hover:bg-gray-800'} transition-colors`}
                >
                  {plan.buttonText}
                </button>
              </div>
